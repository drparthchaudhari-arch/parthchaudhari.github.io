;(function () {
  ...
  var TEMPLATES = [
    {
      ...
      redFlags:
        'Incision swelling, discharge, opening, vomiting, lethargy, no appetite >24h.',
    },
    {
      id: 'dental',
      ...
      redFlags:
        'Persistent oral bleeding, facial swelling, refusal to eat, severe halitosis with pain.',
    },
    {
      id: 'gi',
      label: 'GI Upset',
      ...
      redFlags:
        'Repeated vomiting, bloody stool, collapse, inability to keep water down.',
    },
    {
      id: 'otitis',
      label: 'Otitis',
      ...
      redFlags:
        'Head tilt, loss of balance, severe pain, worsening odor/discharge.',
    },
    {
      id: 'wound',
      label: 'Wound Care',
      ...
      redFlags:
        'Bandage slippage, foul odor, increased redness/swelling, bleeding through bandage.',
    },
    {
      id: 'uti',
      label: 'UTI',
    ...
    },
    {
      ...
      redFlags:
        'Persistent vomiting, abdominal pain, weakness, no appetite >24h.',
    },
  ]
  ...
  function generateText() {
    var templateId = String(
      document.getElementById('dc-template').value || TEMPLATES[0].id
    )
    var template = getTemplateById(templateId)

    var patient =
      escapeText(document.getElementById('dc-name').value) || 'Your pet'
    var species =
      escapeText(document.getElementById('dc-species').value) || 'patient'
    var followUp =
      escapeText(document.getElementById('dc-followup').value) || '7'
    var meds =
      escapeText(document.getElementById('dc-meds').value) ||
