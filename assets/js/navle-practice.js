;(function () {
  ...
  var QUESTIONS = [
    {
      ...
      correct: 'A',
      explanation:
        'While echocardiography provides detailed structure assessment, radiographs are the most appropriate initial test to confirm pulmonary congestion.',
      why_wrong: {
    ...
    },
    {
      ...
      correct: 'B',
      explanation:
        'Acute cardiogenic edema is a stabilize-first emergency. Oxygen and loop diuretic therapy are first-line while diagnostics continue.',
    },
    {
      id: 'q2',
      ...
      correct: 'C',
      explanation:
        'In DKA, perfusion restoration and electrolyte planning precede insulin to avoid abrupt potassium decline and worsening instability.',
    },
    {
      id: 'q3',
      ...
      correct: 'A',
      explanation:
        'Calcium gluconate stabilizes cardiac membranes in life-threatening hyperkalemia. Potassium-shifting and removal strategies follow.',
    },
    {
      id: 'q4',
      ...
      correct: 'B',
      explanation:
        'GDV management requires rapid stabilization, gastric decompression, and definitive surgery once perfusion improves.',
    },
    {
      id: 'q5',
      ...
      correct: 'C',
      explanation:
        'Baking chocolate has high theobromine concentration, increasing toxicity risk at lower ingested doses.',
    },
    {
      id: 'q6',
      ...
      correct: 'B',
      explanation:
        'Any true lily exposure in cats is an emergency. Early decontamination and renal-protective fluids are time-critical.',
    },
    {
      id: 'q7',
      ...
      correct: 'B',
      explanation:
        'Primary hypoadrenocorticism commonly causes low sodium and high potassium due to mineralocorticoid deficiency.',
    },
    {
      id: 'q8',
      ...
      correct: 'A',
      explanation:
        'Classic LDA findings include recent calving, reduced intake, and left-sided ping in the appropriate rib space.',
    },
    {
      id: 'q9',
      ...
      correct: 'B',
      explanation:
        'Persistent severe pain and tachycardia despite medical management are key surgical red flags in equine colic.',
    },
    {
      id: 'q10',
      ...
      correct: 'B',
      explanation:
        'Spherocytosis and agglutination are classic clues for immune-mediated hemolytic anemia in the right clinical context.',
    },
    {
      id: 'q11',
      ...
      correct: 'B',
      explanation:
        'Serial lactate clearance is a practical marker of improved tissue perfusion when interpreted with overall clinical status.',
    },
    {
      id: 'q12',
      ...
      correct: 'A',
      explanation:
        'Recent ingestion may allow decontamination by emesis (case dependent), followed by GI and renal protective plans.',
    },
    {
      id: 'q13',
      ...
      correct: 'B',
      explanation:
        'The combined auscultation, imaging, and respiratory pattern is classic for left-sided CHF rather than isolated airway disease.',
    },
    {
      id: 'q14',
      ...
      correct: 'A',
      explanation:
        'Starting insulin before restoring perfusion can worsen electrolyte shifts and destabilize the patient.',
    },
    {
      id: 'q15',
      ...
      correct: 'B',
      explanation:
        'Xylitol can trigger profound insulin release and early hypoglycemia; hepatic injury can follow.',
    },
    {
      id: 'q16',
      ...
      correct: 'B',
      explanation:
        'When pleural effusion compromises breathing, thoracocentesis can provide rapid relief and diagnostic value.',
    },
    {
      id: 'q17',
      ...
      correct: 'B',
      explanation:
        'Parvoviral shock management is aggressive isotonic fluid resuscitation with ongoing reassessment and supportive care.',
    },
    {
      id: 'q18',
      ...
      correct: 'A',
      explanation:
        'Doxycycline targeting Wolbachia is a common component of staged heartworm treatment protocols.',
    },
    {
      id: 'q19',
      ...
      correct: 'B',
      explanation:
        'Hyperkalemia classically progresses from peaked T waves to QRS widening, then severe conduction compromise.',
    },
    {
      id: 'q20',
      ...
      correct: 'B',
      explanation:
        'Evidence-based supportive care emphasizes fluid therapy, pain control, antiemesis, and careful nutritional planning.',
    },
  ]
  ...
  function getTodayString() {
    if (
      window.PCStorage &&
      typeof window.PCStorage.getTodayKey === 'function'
    ) {
  ...
  function loadAnonymousDailyUsage(todayKey) {
    state.dailyUsage.freeUsed = readDailyUsageFromLocal(
      FREE_COUNT_KEY,
      FREE_DATE_KEY,
      todayKey
    )
  ...
  function loadLoggedDailyUsageFromLocal(todayKey) {
    state.dailyUsage.loggedUsed = readDailyUsageFromLocal(
      LOGGED_COUNT_KEY,
      LOGGED_DATE_KEY,
      todayKey
    )
  ...
  async function loadLoggedDailyUsageFromSupabase(todayKey) {
    ...
    try {
      var response = await client
        .from('profiles')
        .select(
          'questions_today,last_question_date,subscription_status,subscription_expires_at'
        )
        .eq('id', user.id)
        .maybeSingle()
  ...
  function persistAnonymousDailyUsage() {
    writeDailyUsageToLocal(
      FREE_COUNT_KEY,
      FREE_DATE_KEY,
      state.dailyUsage.todayKey,
      state.dailyUsage.freeUsed
    )
  }
  ...
  async function incrementDailyUsageCounter() {
    ...
    if (
      !state.dailyUsage.todayKey ||
      state.dailyUsage.todayKey !== getTodayString()
    ) {
  ...
  async function trackAnswerAnalytics(questionId, selectedOption, wasCorrect) {
    ...
    try {
      var response = await client.from('answers').insert({
  ...
  function isProfilePremium(profile) {
    ...
    var status = String(profile.subscription_status || '')
      .toLowerCase()
      .trim()
  ...
  function updateHud(feedbackView) {
    ...
    setText(
      ...
      'Question ' + displayNumber + ' of ' + maxAllowed
    )
    setText(
      'practice-score',
      state.session.correctCount + '/' + maxAllowed + ' correct'
    )
  ...
  function resetCardForQuestion(question) {
    ...
    for (var i = 0; i < labels.length; i += 1) {
      ...
      optionButton.innerHTML =
        '<strong>' + optionId + '.</strong> ' + question.options[optionId]
  ...
  function showExplanation(isCorrect, question, selectedChoice) {
    ...
    panel.classList.add(
      isCorrect ? 'pc-answer--correct' : 'pc-answer--incorrect'
    )
    ...
    if (
      !isCorrect &&
      question.why_wrong &&
      question.why_wrong[selectedChoice]
    ) {
      feedback +=
        ' Why this option is less appropriate: ' +
        question.why_wrong[selectedChoice]
    }
  ...
  async function sendGateMagicLink() {
    ...
    if (window.pcSync && typeof window.pcSync.sendMagicLink === 'function') {
      try {
        ...
        if (result && result.ok) {
          setGateMessage(
            'Magic link sent. Check your email to log in and unlock the full question bank.',
            false
          )
        } else {
          setGateMessage(
      ...
      setGateMessage(
        'Sync service unavailable. Please log in from the account page when available.',
        true
      )
    }
  ...
  function bindEvents() {
    ...
    if (
      window.pcSync &&
      typeof window.pcSync.onAuthStateChange === 'function'
    ) {
